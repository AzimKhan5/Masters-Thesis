...
df3 = pd.DataFrame(columns=['N/uchisq','g/rchisq','r/ichisq','i/zchisq','u/gchisq','totchisq','reducedtotchisq','totchisq2','reducedtotchisq2','starindex','modelindex'])
df4 = pd.DataFrame(columns=['N/uchisq','g/rchisq','r/ichisq','i/zchisq','u/gchisq','totchisq','reducedtotchisq','totchisq2','reducedtotchisq2','starindex','modelindex'])
...
for x in range(729):
    ...
    df3['totchisq'] =  df3['i/zchisq'] + df3['r/ichisq']
    df3['reducedtotchisq'] = df3['totchisq']
    result_index = df3['reducedtotchisq'].sub(1).abs().idxmin()
    df3['g/rchisq'] = (df2.iloc[x]['g/r'] - df1.iloc[result_index]['g/r'])**2  / (df2.iloc[x]['e_g/r'])**2
    df3['N/uchisq'] = (df2.iloc[x]['N/u'] - df1.iloc[result_index]['N/u'])**2  / (df2.iloc[x]['e_N/u'])**2
    df3['u/gchisq'] = (df2.iloc[x]['u/g'] - df1.iloc[result_index]['u/g'])**2  / (df2.iloc[x]['e_u/g'])**2
    df3['totchisq2'] =  df3['g/rchisq'] + df3['i/zchisq'] + df3['N/uchisq'] + df3['r/ichisq'] +  df3['u/gchisq']
    df3['reducedtotchisq2'] = df3['totchisq2']/4
    df3['starindex'] = x
